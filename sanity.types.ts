...
// Query: *[      _type == "product" && featured == true    ] | order(_createdAt desc) {      _id,      _type,      _createdAt,      _updatedAt,      _rev,      name,      price,      slug,      image,      description,      featured,      category->{        _id,        _type,        name,        slug      }    }
